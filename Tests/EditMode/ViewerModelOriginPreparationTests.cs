...
{
    public sealed class ViewerModelOriginPreparationTests
    {
        [Test]
        ...
        private sealed class SilentEventPublisher : IViewerEventPublisher
        {
