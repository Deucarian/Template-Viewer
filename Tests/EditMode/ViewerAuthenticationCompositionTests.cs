...
{
    public sealed class ViewerAuthenticationCompositionTests
    {
        [Test]
        public void BootstrapDefersCompositionForRuntimeConnectionRegistration()
        {
            ...
            try
            {
                ...
                MethodInfo start = typeof(ViewerBootstrap).GetMethod(
                    "Start",
        ...
        public void ConnectionAndTemplateAuthenticatedOriginsAreCombined()
        {
            ...
            try
            {
                ReferenceViewerBootstrap bootstrap =
                    root.AddComponent<ReferenceViewerBootstrap>();
                FieldInfo originsField = typeof(ViewerBootstrap).GetField(
        ...
        {
            FieldInfo sessionField = typeof(ViewerBootstrap).GetField(
        ...
        public void BootstrapConsumesResolvedConnectionWithoutALocalTarget()
        {
            ...
            try
            {
                ...
                FieldInfo localRegistrationField =
                    typeof(ViewerBootstrap).GetField(
        ...
        public void BootstrapComposesTheSharedEndpointProviderFromItsProfile()
        {
            ...
            try
            {
                ...
                MethodInfo createProvider = typeof(ViewerBootstrap)
                    .GetMethod(
        ...
        {
            MethodInfo method = typeof(ViewerBootstrap).GetMethod(
                name,
                BindingFlags.Static |
