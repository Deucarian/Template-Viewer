...
{
    public enum ViewerLifecycleState
    {
        Created,
        Loading,
        Ready,
    ...
    [Serializable]
    public sealed class ViewerInitializeRequest
    {
        ...
        /// </summary>
        [JsonIgnore]
        public ViewerModelPlacement ModelPlacement { get; set; }
    ...
    public sealed class ViewerModelPlacement
    {
        public ViewerModelPlacement()
    ...
    [Serializable]
    public sealed class ViewerSelectionRequest
    {
        [JsonProperty("revision")]
        public long Revision { get; set; }
    ...
    [Serializable]
    public sealed class ViewerRevisionRequest
    {
        [JsonProperty("revision")]
        public long Revision { get; set; }
    }

    public readonly struct ViewerModelDescriptor
    {
        public ViewerModelDescriptor(
            string sourceUrl,
            string modelId,
            string modelVersion,
            uint? cacheVersion,
    ...
    public sealed class ViewerModelLoadResult
    {
        private ViewerModelLoadResult(
            bool succeeded,
        ...
        public static ViewerModelLoadResult Success(GameObject root) =>
            new ViewerModelLoadResult(true, root, string.Empty);

        public static ViewerModelLoadResult Failure(string message) =>
            new ViewerModelLoadResult(false, null, message);
    }

    public interface IViewerModelDescriptorResolver
    {
        bool TryResolve(
    ...
    public interface IViewerModelLoader : IDisposable
    {
        Task<ViewerModelLoadResult> LoadAsync(
    ...
    public interface IViewerEventPublisher
    {
        Task PublishAsync(
            string eventName,
            JObject payload,
